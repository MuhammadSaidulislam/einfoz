...
import { faClock, faComment, faCubes, faMapMarker, faThumbsUp } from '@fortawesome/free-solid-svg-icons';
          ...
          <div className="col cardHeading">
            ...
            <div className="d-flex">
              <p className="card-link openNow">
                ...
                {moment(props.created_at).format('DD MMM YY [at] hh.mmA').toLowerCase()}
              </p>
              <p className="card-link">
