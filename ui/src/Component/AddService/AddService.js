...
import { addPost, addProfile, profileList } from '../../api/profile';
...
const AddService = (props) => {
    ...
    return (
        <div>
        <Modal show={props.show} onHide={props.handleClose} centered className='userModal'>
        <button className='closeModal btn' onClick={props.handleClose}><FontAwesomeIcon icon={faXmark} /></button>
        <div className='userModalBox'>
            ...
            <form ref={form} onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='inputField mt-3'>
                    <label>Sub-Category (profile dropdown)</label>
                    <Form.Select aria-label="Default select example" {...register("profile")}>
                ...
                <div className='inputField mt-3'>
                    <label>Link (price)</label>
                    <input type='text' {...register("price")} placeholder='Enter your course length' className='form-control' required />
                </div>
                <div className='inputField mt-3'>
                    <label>Details</label>
